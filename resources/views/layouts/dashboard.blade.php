...
<head>
    ...
    <title> Mobile Hospital Dashboard </title>
                    ...
                    <div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                <img src="{!! asset('fontendAsset') !!}/img/logo.png" class="img-fluid mr-2" alt="avatar">
            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="index.html">
                            <img src="{!! asset('fontendAsset') !!}/img/logo.png" class="navbar-logo" alt="logo">
                        </a>
                    </li>
                    <li class="nav-item theme-text">
                        <a href="index.html" class="nav-link"> 786-MH </a>
                    </li>
                </ul>
