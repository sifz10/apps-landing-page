...
<!-- Mirrored from droitthemes.com/html/wavee/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Feb 2021 07:35:51 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{!! asset('fontendAsset') !!}/vendors/magnify-popup/magnific-popup.css">
    <link rel="stylesheet" href="{!! asset('fontendAsset') !!}/css/style.css">
    <link rel="stylesheet" href="{!! asset('fontendAsset') !!}/css/responsive.css">
    <title>Terms And Conditions | 786 Mobile Hospital</title>
</head>
...
<body>
    <div class="body_wrapper">
        ...
        <!--        header     -->
        <!--        breadcrumb_area     -->
        <section class="breadcrumb_area parallaxie" data-background="{!! asset('fontendAsset') !!}/img/bg.jpg" style="background: url({!! asset('fontendAsset') !!}/img/breadcrumb_bg_one.jpg) no-repeat;">
    ...
    <script src="{!! asset('fontendAsset') !!}/vendors/magnify-popup/jquery.magnific-popup.min.js"></script>
    <script src="{!! asset('fontendAsset') !!}/js/custom.js"></script>
</body>


<!-- Mirrored from droitthemes.com/html/wavee/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 14 Feb 2021 07:36:10 GMT -->
</html>
